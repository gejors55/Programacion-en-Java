...
// Incluye código para selección múltiple en la lista.
...
public class EjemploListaYCombo3 extends JFrame implements ActionListener {
	public static final String COMMAND_ANNADIR = "Añadir";
	...
	private void aniadirItem(String s) {
		if (modelo.contains(s)) {
			JOptionPane.showMessageDialog(this, "Ya está en la lista.");
		} else
			modelo.addElement(s);
	}
